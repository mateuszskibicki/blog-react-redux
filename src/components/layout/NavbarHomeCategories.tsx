  ...
  return (
    <div className="navbar__categories d-flex align-items-center justify-content-center">
      ...
      <div className="dropdown">
        ...
        {visibleCategories && (
          <div
            className="dropdown-menu shadow border-0 rounded-0"
...
export const IconFullStack: React.FC = (): JSX.Element => (
  <svg
    aria-hidden="true"
    focusable="false"
    data-prefix="fas"
...
export const BackEndIcon: React.FC = (): JSX.Element => (
  <svg
    aria-hidden="true"
    focusable="false"
    data-prefix="fas"
...
export const FrontEndIcon: React.FC = (): JSX.Element => (
  <svg
    aria-hidden="true"
    focusable="false"
    data-prefix="fab"
